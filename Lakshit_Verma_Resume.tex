...
\item Working under Senior Professor Dr. Manohara Pai and Schneider Electric on AI-enabled security analysis and testcase generation.
\item Developing a novel framework that leverages Large Language Models (LLMs) to automatically parse CVE, CWE and MITRE databases to generate comprehensive security test cases for embedded systems.
\end{rSubsection}
...
\itemsep -0.5em
\item Awarded \textbf{\#1 Position} and \textbf{2,00,000 INR} in the ISEA-ISAP 2026 Hackathon-CTF organized by IIT Madras.\hfill\textbf{(Team Leader)}
...
\begin{rSection}{Education}
    ...
    {Bachelor of Technology --- Electronics Engineering (VLSI Design \& Technology)} \hfill Currently in VIth Semester \\
\end{rSection}
